...
| U2 | 1 | Infineon BTS500601TEAAUMA2 | Main 12 V high-side power switch | Automotive PROFET, ~6 mΩ, protected switch with analog current sense | 4.40 |
...
| --- | ---: | --- | --- | --- | ---: |
| Q2 | 1 | Vishay SQ7415CENW-T1_GE3 | Supervisor self-latch P-MOSFET | Automotive AEC-Q101, -60 V, 16 A class; ample for the supervisor load and more transient margin than the prior -40 V selection | 1.46 |
...
| Q3,Q4 | 2 | 2N3904 or MMBT3904 | ACC wake and Uno self-hold gate pull-down | General-purpose NPN; use documented 40 V or higher parts | ~0.28 |
| DZ1 | 1 | BZD27C12PWH or equivalent 12 V automotive Zener | Protect Q2 VGS | AEC-Q101 preferred, 1 W class | 0.53 |
...
The current **core/specialty component subtotal is about $52–53 before shipping**. A fully stocked Rev A build, including passives, fuse holder, service switch, and thermistor, should land around **$60–70 before tax** if none of those common parts are already available in the shop. This excludes the Raspberry Pi, Active Cooler, existing Arduino Uno, enclosure, bulk wire, and USB hub.

See `PROCUREMENT.md` for the current buying plan and supplier comparison.
